...
def lambda_handler(event, context):
    ...
    food_choice = event['queryStringParameters']['food']
    ...
    response_body = f"<h1>{suggestion}</h1><a href='https://8j55p9z8kf.execute-api.ap-southeast-2.amazonaws.com/dev/library/{try_id}'> Save to favourites!</a> <img src={try_image} alt='Beer pic!' width='190' height='400'>"
